<template>
  ...
  <Card shadow v-show="!addModal">
    <Row>
      <Col span="3">
        <Button @click="add" type="primary" icon="ios-add">新增入库</Button>
      </Col>
      <Col span="21">
        <Form inline>
          <FormItem>
            <DatePicker style="width: 200px" v-model="search.date_range" type="daterange" :options="dateOption" placeholder="入库日期"></DatePicker>
          </FormItem>
          <FormItem>
            <Select style="width: 200px" v-model="search.stock_way" placeholder="入库类型" clearable>
